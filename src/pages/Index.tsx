...
const SERVICES = [
  {
    ...
    options: [
      { label: "Пайка титановых оправ", price: "от 1 200 ₽" },
      { label: "Пайка металлических оправ", price: "от 1 200 ₽" },
      { label: "Пайка пластиковых оправ", price: "от 800 ₽" },
      { label: "Замена флекса", price: "от 1 000 ₽" },
      { label: "Замена шарнира", price: "от 500 ₽" },
      { label: "Замена лески", price: "от 500 ₽" },
      { label: "Выправка", price: "от 200 ₽" },
      { label: "Замена наконечников", price: "от 500 ₽" },
    ],
  },
  {
    name: "Линзы в наличии и на заказ",
    price: "от 2 500 ₽",
    desc: "Линзы по рецепту, антибликовые, астигматические, без покрытия, утонченные от ведущих производителей",
    tag: "Популярно",
    ...
    details: "Предлагаем широкий выбор очковых линз от ведущих мировых производителей. Быстро установим линзы в вашу оправу или закажем индивидуальные линзы по вашему рецепту с учетом всех параметров зрения.",
    options: [
...

  {
    ...
    options: [
      { label: "Изготовление очков в ободковую оправу", price: "от 250 ₽" },
      { label: "Изготовление очков в лесочную оправу", price: "от 400 ₽" },
  ...
  return (
    <>
      <header className="header">
        <div className="logo">
          <img src="https://cdn.poehali.dev/projects/437a93b1-5f82-4463-b584-1d03eba1ecc3/bucket/1074aa46-e501-49ec-99d8-bfd5921657e6.png" alt="Очки Плюс" style={{ height: 96, width: "auto", display: "block", transform: "scaleX(1.15)" }} />
        </div>
        <nav>
      ...
      <main>
        ...
        <div className="marquee">
          <div className="marquee-content">
            &nbsp; * РЕМОНТ ОПРАВ * ЗАМЕНА ЛИНЗ * ОЧКИ НА ЗАКАЗ * СРОЧНО ЗА ЧАС * ГАРАНТИЯ КАЧЕСТВА *
            РЕМОНТ ОПРАВ * ЗАМЕНА ЛИНЗ * ОЧКИ НА ЗАКАЗ * СРОЧНО ЗА ЧАС * ГАРАНТИЯ КАЧЕСТВА
          </div>
        </div>
          ...
          <div className="menu-grid">
            ...
            <div className="menu-card">
              ...
              <div className="menu-card-body">
                ...
                <p style={{ fontSize: "14px", color: "#666" }}>
                  Профессионально выполним ремонт очков любой сложности: пайка металлических оправ, замена флексов, носоупоров, винтов, восстановление дужек и других элементов. Работаем быстро, аккуратно и с гарантией качества.
                </p>
              </div>
            </div>
            ...
            <div className="menu-card">
              ...
              <div className="menu-card-body">
                ...
                <p style={{ fontSize: "14px", color: "#666" }}>
                  Изготовим новые линзы по индивидуальному рецепту и выполним точную установку в вашу оправу. Используем качественные линзы с современными защитными покрытиями для максимального комфорта зрения.
                </p>
              </div>
            </div>
            ...
            <div className="menu-card">
              ...
              <div className="menu-card-body">
                ...
                <p style={{ fontSize: "14px", color: "#666" }}>
                  Предлагаем широкий выбор очковых линз от ведущих мировых производителей. Быстро установим линзы в вашу оправу или закажем индивидуальные линзы по вашему рецепту с учетом всех параметров зрения.
                </p>
              </div>
            </div>
          </div>
        ...
        <section id="about" className="retro-vibe">
          <div>
            ...
            <p className="vibe-text">
              Мы не просто ремонтируем очки — мы создаём комфортное и качественное зрение для каждого клиента.
            </p>
            <p className="vibe-text" style={{ marginTop: 12 }}>
              Уже более 10 лет мы профессионально занимаемся изготовлением, ремонтом и обслуживанием очков, гарантируя высокое качество, точность исполнения и индивидуальный подход к каждому заказу.
            </p>
            <ul style={{ listStyle: "none", padding: 0, margin: "20px 0 28px", display: "flex", flexDirection: "column", gap: 8 }}>
              {[
                ...
                "Замена линз любой сложности",
                "Ремонт оправ и пайка любой сложности",
                "Детские линзы для контроля миопии",
                "Очковые линзы в наличии и под индивидуальный заказ",
              ].map(item => (
            ...
            <p style={{ color: "rgba(255,255,255,0.7)", fontSize: 14, marginBottom: 16, fontWeight: 600, letterSpacing: 1 }}>
              БЫСТРО. ТОЧНО. НАДЁЖНО.
            </p>
            <p className="vibe-text" style={{ marginBottom: 24 }}>
              Мы заботимся о вашем зрении и делаем каждый взгляд максимально комфортным и чётким.
            </p>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 40 }}>
              <div>
                ...
                <p style={{ fontSize: 17, color: "var(--gray)", lineHeight: 1.75, marginBottom: 20 }}>
                  Мы основали мастерскую в 2015 году с одной целью — делать качественные очки быстро и честно. За эти годы тысячи клиентов доверили нам своё зрение.
                </p>
      ...
      <footer>
        <div>
          ...
          <p style={{ color: "var(--gray)", lineHeight: 1.6, fontSize: 14 }}>
            Срочный ремонт и изготовление очков в Якутске. Стабильный и качественный сервис по изготовлению и ремонту очков, которому доверяют клиенты и партнёры.
          </p>
        </div>
      ...
      {/* SEO-блоки */}
      <section style={{ background: "var(--bg-section)", borderRadius: 24, margin: "12px 0", padding: "64px 20px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <h2 className="section-title" style={{ textAlign: "center", marginBottom: 16 }}>Срочное изготовление очков в Якутске</h2>
          <p style={{ color: "var(--gray)", fontSize: 17, lineHeight: 1.7, marginBottom: 20 }}>
            Оптическая мастерская «Очки Плюс» — единственная в Якутске, где очки по рецепту изготавливают <strong>за 1 час</strong>. Не нужно ждать несколько дней: приходите с рецептом от офтальмолога, выбираете оправу из широкого ассортимента, и уже через час забираете готовые очки.
          </p>
          <p style={{ color: "var(--gray)", fontSize: 17, lineHeight: 1.7, marginBottom: 20 }}>
            Используем линзы ведущих мировых производителей: <strong>Zeus, Rodenstock, Essilor</strong>. Любая степень коррекции — от простых однофокальных до прогрессивных и бифокальных линз. Подбор линз по параметрам вашего рецепта — бесплатно.
          </p>
          <p style={{ color: "var(--gray)", fontSize: 17, lineHeight: 1.7 }}>
            Работаем с 2015 года. За это время изготовили очки более чем 5 000 клиентам из Якутска и Якутии. Принимаем рецепты от любых офтальмологов, в том числе детские. Запись онлайн или по телефону — без очередей.
          </p>
        </div>
      </section>

      <section style={{ background: "white", borderRadius: 24, margin: "12px 0", padding: "64px 20px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <h2 className="section-title" style={{ textAlign: "center", marginBottom: 16 }}>Ремонт очков в Якутске</h2>
          <p style={{ color: "var(--gray)", fontSize: 17, lineHeight: 1.7, marginBottom: 20 }}>
            Сломались очки? Мастерская «Очки Плюс» выполняет <strong>срочный ремонт очков в Якутске</strong> — в большинстве случаев прямо при клиенте за 15–30 минут. Ремонтируем оправы любой сложности: металлические, пластиковые, титановые, детские.
          </p>
          <p style={{ color: "var(--gray)", fontSize: 17, lineHeight: 1.7, marginBottom: 20 }}>
            Виды ремонта: пайка и сварка оправ, замена петель и винтиков, замена носоупоров, восстановление дужек, правка и регулировка посадки. Если оправа не подлежит ремонту — поможем подобрать замену из нашего ассортимента.
          </p>
          <p style={{ color: "var(--gray)", fontSize: 17, lineHeight: 1.7 }}>
            Принимаем очки на ремонт без предварительной записи. Адрес: г. Якутск, ул. Орджоникидзе, 20, кабинет 207. Режим работы: понедельник–суббота с 10:00 до 18:00.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "var(--bg-section)", borderRadius: 24, margin: "12px 0", padding: "64px 20px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <h2 className="section-title" style={{ textAlign: "center", marginBottom: 16 }}>Замена линз в Якутске</h2>
          <p style={{ color: "var(--gray)", fontSize: 17, lineHeight: 1.7, marginBottom: 20 }}>
            Изменилось зрение или поцарапались линзы? Мы заменим линзы в вашей любимой оправе быстро и качественно. Сохраните удобную оправу — установим новые линзы точно по вашему рецепту. Услуга доступна для большинства типов оправ.
          </p>
          <p style={{ color: "var(--gray)", fontSize: 17, lineHeight: 1.7, marginBottom: 20 }}>
            Предлагаем линзы с различными покрытиями: <strong>антибликовое, упрочняющее, UV-защита, фотохромные</strong> (хамелеон). Стоимость зависит от параметров рецепта и выбранного типа линз — уточните цену при визите или по телефону.
          </p>
          <p style={{ color: "var(--gray)", fontSize: 17, lineHeight: 1.7 }}>
            Замена линз в готовых очках занимает от 1 часа. Привозите оправу и рецепт — сделаем всё быстро. Работаем без выходных в субботу.
          </p>
        </div>
      </section>
      ...
      <section style={{ background: "white", borderRadius: 24, margin: "12px 0", padding: "64px 20px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          <h2 className="section-title" style={{ textAlign: "center", marginBottom: 16 }}>Изготовление и ремонт очков — часто задаваемые вопросы</h2>
          <div style={{ display: "flex", flexDirection: "column", gap: 24, marginTop: 32 }}>
            {[
              { q: "Сколько стоит изготовление очков в Якутске?", a: "Стоимость зависит от оправы и типа линз. Простые однофокальные линзы с оправой — от 3 000 ₽. Прогрессивные линзы — от 8 000 ₽. Точную цену рассчитаем бесплатно при визите." },
              { q: "Как долго делают очки?", a: "В большинстве случаев — 1 час. Для сложных рецептов или специальных линз — от 1 до 3 дней. Уточняйте при заказе." },
              { q: "Принимаете ли вы рецепты от любых врачей?", a: "Да, принимаем рецепты от любых офтальмологов и оптометристов. Также можем помочь разобраться в рецепте, если он написан непонятно." },
              { q: "Можно ли отремонтировать очки без записи?", a: "Да, приходите в любое удобное время в рабочие часы. Большинство видов ремонта выполняем сразу при клиенте." },
              { q: "Есть ли у вас очки для детей?", a: "Да, у нас есть детские оправы и мы изготавливаем очки по детским рецептам. Детские оправы подбираются с учётом возраста и особенностей лица ребёнка." },
            ].map(({ q, a }, i) => (
              <div key={i} style={{ borderRadius: 16, border: "1px solid rgba(0,0,0,0.08)", padding: "24px 28px", background: "var(--bg-section)" }}>
                <h3 style={{ fontSize: 18, fontWeight: 600, color: "var(--dark)", marginBottom: 10 }}>{q}</h3>
                <p style={{ color: "var(--gray)", fontSize: 16, lineHeight: 1.6, margin: 0 }}>{a}</p>
              </div>
            ))}
          </div>
        </div>
