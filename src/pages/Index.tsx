  ...
  return (
    <>
      <header className="header">
        <div className="logo">
          <img src="https://cdn.poehali.dev/projects/437a93b1-5f82-4463-b584-1d03eba1ecc3/bucket/1074aa46-e501-49ec-99d8-bfd5921657e6.png" alt="Очки Плюс" style={{ height: 96, width: "auto", display: "block" }} />
        </div>
        <nav>
